...
{
    public partial class QuickActionsWidget : UserControl, IDashboardWidget, INotifyPropertyChanged
    {
        public ViewMode[] SupportedModes => new[] { ViewMode.Novice };
        public string Title { get; set; } = "Quick Actions";
        ...
        public WidgetConfiguration Configuration { get; set; } = new WidgetConfiguration { WidgetId = "quick_actions_novice" };
        ...
        { 
            Title = "Quick Actions";
            Configuration.WidgetId = "quick_actions_novice";
        }
