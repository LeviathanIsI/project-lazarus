...
{
    public partial class RecentActivityWidget : UserControl, IDashboardWidget, INotifyPropertyChanged
    {
        ...
        public WidgetConfiguration Configuration { get; set; } = new WidgetConfiguration { WidgetId = "recent_activity_enthusiast" };
        ...
        { 
            ...
            Configuration.WidgetId = "recent_activity_enthusiast";
        }
