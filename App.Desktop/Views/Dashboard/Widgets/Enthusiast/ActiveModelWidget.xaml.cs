...
{
    public partial class ActiveModelWidget : UserControl, IDashboardWidget, INotifyPropertyChanged
    {
        public ViewMode[] SupportedModes => new[] { ViewMode.Enthusiast };
        public string Title { get; set; } = "Active Model";
        ...
        public WidgetConfiguration Configuration { get; set; } = new WidgetConfiguration { WidgetId = "active_model_enthusiast" };
        ...
        public ActiveModelWidget() 
        { 
            Title = "Active Model";
            Configuration.WidgetId = "active_model_enthusiast";
        }
