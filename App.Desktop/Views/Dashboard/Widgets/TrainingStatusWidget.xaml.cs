...
{
    public partial class TrainingStatusWidget : UserControl, IDashboardWidget, INotifyPropertyChanged
    {
        public ViewMode[] SupportedModes => new[] { ViewMode.Novice };
        public string Title { get; set; } = "Training Status";
        ...
        public WidgetConfiguration Configuration { get; set; } = new WidgetConfiguration { WidgetId = "training_status_novice" };
        ...
        { 
            ...
            Configuration.WidgetId = "training_status_novice";
        }
