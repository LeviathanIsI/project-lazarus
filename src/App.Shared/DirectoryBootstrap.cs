...
public static class DirectoryBootstrap
{
    ...
    public static System.Collections.Generic.IReadOnlyList<string> LeafDirectories => new[]
    {
        ...
        LazarusPaths.GenAssets.IblMaps,
        LazarusPaths.GenAssets.Shaders,
        LazarusPaths.GenAssets.TextureTools,
        LazarusPaths.GenAssets.TextureTools_KtxCache,
        LazarusPaths.GenAssets.TextureTools_GltfTransform,
        LazarusPaths.GenAssets.TextureTools_Gltfpack,
        ...
        LazarusPaths.SystemData.Thumbnails,
        LazarusPaths.SystemData.Thumbnails3D,
        LazarusPaths.SystemData.Physics,
        LazarusPaths.SystemData.Physics_Meshes,
        LazarusPaths.SystemData.Tools,
        LazarusPaths.SystemData.Tools_Ffmpeg,
        LazarusPaths.SystemData.Tools_Ktx,
        LazarusPaths.SystemData.Tools_Basisu,
        ...
        LazarusPaths.Runners.HelixRoot,
        LazarusPaths.Runners.Helix_AssimpCache,
